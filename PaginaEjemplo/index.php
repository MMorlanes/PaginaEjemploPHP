<html>
 <head>
    <link rel="">
  <link rel="stylesheet" href="Libreria/bootstrap-5.3.3-dist/css/bootstrap.min.css">
  <script src="Libreria/bootstrap-5.3.3-dist/js/bootstrap.bundle.min.js"></script>
  <link rel="stylesheet" href="../PaginaEjemplo/css/app.css">
 </head>
 <body>
    <div class="container-fluid" id="capaEncabezado">
        <div class="row">
            <div class="col-md-2 col-sm-9 d-none d-sm-block">
                <img src="../PaginaEjemplo/img/logo.png" style="height: 5rem;">
            </div>
            <div class="col-md-8 d-none d-md-block divTitulo">
                Miguel Morlanes 
            </div><div class="col-md-2 col-sm-3 d-none d-sm-block">
                login
            </div>
        </div>
    </div>
