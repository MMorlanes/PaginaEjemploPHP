            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <div>
                    <div class="form-check">
                        <input type="radio" id="sexoM" name="sexo" value="H" <?php echo $cHombre; ?> class="form-check-input"/>
                        <label for="sexoM" class="form-check-label">Hombre</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" id="sexoF" name="sexo" value="M" <?php echo $cMujer; ?> class="form-check-input"/>
